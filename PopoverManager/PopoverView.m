...
{
	if (_isPresented) {
		[_delegate dismissPopoverView:self withViewController:_modalViewController animated:YES];
		_isPresented = NO;
	}
}
...
#endif
		[_delegate presentPopoverView:self withViewController:_modalViewController animated:YES];
		_isPresented = YES;
	}
}
